                                    ...
                                    <div class="card-body">
                                        <form action='adminValidatePassword.php' method='post'>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputPassword" type="password" placeholder="Enter Password" name="adminPassword"/>
                                            </div>
                    ...
                    <div class="container-fluid" style="padding-top:0.05rem;">
                        <div class="d-flex align-items-center justify-content-between small">
                            ...
                            <div class="text-white-50">
                                <a class="text-white-50" href="#">Admin Manual</a>
                                &middot;
                                <a class="text-white-50" href="#">PhpMyAdmin Manual</a>
                            </div>
                        </div>
                    </div>
                </footer>
